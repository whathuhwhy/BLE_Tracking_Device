...
def on_publish_received(publish_packet_data):
    ...
    if data_dict["timestamp"] is not None:
        print(f"timestamp: {data_dict["timestamp"]}, Touch toogle: {data_dict["touch"]}, Motion sensor: {data_dict["motion"]}")
    utils.insert_reading(data_dict["timestamp"], data_dict["touch"], data_dict["motion"])
