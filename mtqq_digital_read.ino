...
int Touch_Val_Sensor = 0; 
int Motion_Val_Sensor = 0;
...
void sendToAWS() {
  ...
  //int temp_sensorValue = analogRead(Temp_Pin_Sensor);//
  int touch_sensorValue = digitalRead(TOUCH_PIN);
  int motion_sensorValue = digitalRead(PIR_PIN);
  message["touch"] =  touch_sensorValue;
  message["motion"] = motion_sensorValue;
